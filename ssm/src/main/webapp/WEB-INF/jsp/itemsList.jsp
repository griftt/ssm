...
function deleteItems() {
	document.itemsForm.action = "${pageContext.request.contextPath }/item/delete.action"
...
<tr>
	...
	<td><a href="${pageContext.request.contextPath }/items/edit.action?id=${item.id}">修改</a></td>
